...
const FnbSeoulland = () => {
  ...
  const getDatas = async () => {
    const response = await fetch(`https://port-0-playtopia-rccln2llw1nwqng.sel5.cloudtype.app/fnb/list/?company=seoulland&fnb_type=${type}`);
  ...
  return (
    <div className='notosanskr'> 
      ...
      <S.Header1>FnB</S.Header1>
        ...
        <S.NavTypeSelector childAmount={4} id='nav-container'>
          ...
          <S.BtnTypeSelector id='conveniencestore' onClick={()=>{setType('conveniencestore')}} >편의점</S.BtnTypeSelector>
          <S.SearchWrapper childAmount={4}>
